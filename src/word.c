	...
	/**
	* @brief Crée un nouvel objet Word et l'ajoute dans une liste chaînée.
	* 
	* @param word 
	* @param lineNumber 
	* @param fileName 
	...
	*/
	...
	/**
	* @brief Vérifie si un mot donné existe déjà dans la liste chaînée des mots. 1 si ça existe,  0 sinon
	* 
	* @param wordList 
	* @param word 
	* @return int 
	*/
	...
	/**
	* @brief Ajoute un mot dans la liste chaînée des mots. Si le mot existe déjà, met à jour le nombre d'occurrences et les numéros de ligne correspondants. 
	* 
	* @param wordList 
	* @param word 
	* @param lineNumber 
	...
	*/
	...
	/**
	* @brief Affiche tous les mots dans la liste chaînée, leur nombre d'occurrences, ainsi que les numéros de lignes et le nom du fichier où chaque mot apparaît.
	* 
	* @param linkedList 
	*/
